                    ...
                    <div class="col-12">
                        <div class="slide-content-txt-div">
                            ...
                            <div class="text-center mt-lg-5 mt-md-3 mt-sm-3 mt-3 learn-more-book-btns">
                                ...
                                <a href="<?php echo get_site_url();?>/<?php echo ($lang_code == 'zh-hant') ? 'zh-hant/':'';  ?>services"
                                    class="slide-btns">
...
<div class="container">
    ...
    <!-- <div class="row pt-4 pb-4  service-row gx-0 mobile-reverse">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 pe-lg-4 pe-md-0 pe-sm-0  pe-0  ">
    ...
    <!-- <div class="row pt-4 pb-4  service-row gx-0 mobile-reverse">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-12  pe-lg-4 pe-md-0 pe-sm-0  pe-0  ">
